...
export default function Sidebar() {
    ...
    return (
        <aside data-testid="sidebar-desktop" className="hidden md:flex w-72 bg-[var(--studio-bg)] border-r border-[var(--studio-border)] flex flex-col h-screen sticky top-0 px-6 py-8">
